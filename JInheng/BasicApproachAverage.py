...
def main():
    ...
    while True:
        ...
        if  positions_and_cash[case[0]]["volume"] < -volume_basket:
            if exchange.get_last_price_book(case[0]).bids[0].price < float(C1_b_pre_b_price/iterator):
                exchange.insert_order(case[0], price=exchange.get_last_price_book(case[0]).bids[0].price + 0.1, volume=volume_basket, side=SIDE_BID, order_type=ORDER_TYPE_IOC)
        elif  positions_and_cash[case[0]]["volume"] > volume_basket :
            if exchange.get_last_price_book(case[0]).asks[0].price > float(C1_b_pre_s_price/iterator):
                exchange.insert_order(case[0], price=exchange.get_last_price_book(case[0]).asks[0].price - 0.1, volume=volume_basket, side=SIDE_ASK, order_type=ORDER_TYPE_IOC)
        ...
        if  positions_and_cash[case[1]]["volume"] < -volume_stock:
            if exchange.get_last_price_book("C1_GAS_INC").bids[0].price < float(C1_s1_pre_b_price/iterator):
                exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_GAS_INC").bids[0].price + 0.1, volume=volume_stock, side=SIDE_BID, order_type=ORDER_TYPE_IOC)
            ...
            if exchange.get_last_price_book("C1_GAS_INC").asks[0].price > float(C1_s1_pre_s_price/iterator):
                exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_GAS_INC").asks[0].price - 0.1, volume=volume_stock, side=SIDE_ASK, order_type=ORDER_TYPE_IOC)
        ...
        if  positions_and_cash[case[2]]["volume"] < -volume_stock:
            if exchange.get_last_price_book("C1_OIL_CORP").bids[0].price < float(C1_s2_pre_b_price/iterator):
                exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_OIL_CORP").bids[0].price + 0.1, volume=volume_stock, side=SIDE_BID, order_type=ORDER_TYPE_IOC)
            ...
            if exchange.get_last_price_book("C1_OIL_CORP").asks[0].price > float(C1_s2_pre_s_price/iterator):
                exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_OIL_CORP").asks[0].price - 0.1, volume=volume_stock, side=SIDE_ASK, order_type=ORDER_TYPE_IOC)
        ...
        if len(result)<=1: 
            ...
            if  positions_and_cash[case[0]]["volume"] < -volume_basket:
                if exchange.get_last_price_book("C1_FOSSIL_FUEL_ETF").bids[0].price < float(C1_b_pre_b_price/iterator):
                    exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_FOSSIL_FUEL_ETF").bids[0].price + 0.1, volume=volume_basket, side=SIDE_BID, order_type=ORDER_TYPE_IOC)
            elif  positions_and_cash[case[0]]["volume"] > volume_basket :
                if exchange.get_last_price_book("C1_FOSSIL_FUEL_ETF").asks[0].price > float(C1_b_pre_s_price/iterator):
                    exchange.insert_order("C1_FOSSIL_FUEL_ETF", price=exchange.get_last_price_book("C1_FOSSIL_FUEL_ETF").asks[0].price - 0.1, volume=volume_basket, side=SIDE_ASK, order_type=ORDER_TYPE_IOC)
